# Verex — 2026-08-03 Batch Plan: CI/CD · LMSR · UMA (archived)

> **Archived 2026-08-21.** This is the 2026-08-03 batch plan — CI/CD · LMSR · UMA, delivered in
> waves — kept verbatim the way [jul-28-plan.md](jul-28-plan.md) was. **Waves 0–2 shipped and all
> five gates closed;** what never happened is wave 3's verification tail (a fresh staging seed and
> one market resolved end-to-end through the live Sepolia UMA adapter), plus the CI half of task 2
> (`ci.yml` was specified here and never written). Those, and the items this plan explicitly
> deferred (LMSR phase B, the indexer, Chainlink), moved to
> [../features/README.md → Backlog](../features/README.md#backlog). The rolling plan restarted at
> [current-plan.md](current-plan.md); the roadmap-status table below was carried forward there.
